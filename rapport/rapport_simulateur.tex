...
\begin{itemize}
    \item Ajouter le support des opérations RAM et ROM ;
    \item Ajouter un mode de traitement par lot (pour calculer d'un seul coup les sorties après $n$ cycles sur un jeu d'entrées) ;
